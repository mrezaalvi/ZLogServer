<script setup>
    ...
    const deleteUser = (user) => {
        form.delete(route('manajemen-pengguna.destroy',user), {
            preserveScroll: true,
                                ...
                                <tr v-for="user in users" :key="user.id">
                                    ...
                                    <td class="w-px px-6 py-4 whitespace-nowrap">
                                        <div class="flex space-x-2">
                                            ...
                                            <button @click="confirmUserDeletion" class="inline-flex items-center px-3 py-2.5 text-sm text-red-600 font-medium hover:text-red-700 hover:underline">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 mr-2 stroke-2">
                                    ...
                                    <DialogModal :show="confirmingUserDeletion" @close="closeModal">
                                        ...
                                        <template #content>
                                            Apakah Anda yakin ingin menghapus data ini? Setelah akun dihapus, semua sumber daya dan data akan dihapus secara permanen. 
                                        </template>
